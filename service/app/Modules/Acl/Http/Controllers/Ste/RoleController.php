...
use App\Modules\Acl\Http\Requests\Ste\CreateRoleRequest;
use App\Modules\Acl\Http\Requests\Ste\UpdateRoleRequest;
use App\Modules\Acl\Http\Resources\Role as RoleResource;
use App\Modules\Acl\Repositories\RoleRepository as Role;
use App\Modules\Acl\Http\Requests\Ste\SyncPermissionRequest;
use App\Modules\Acl\Http\Requests\Ste\AttachPermissionRequest;
use App\Modules\Acl\Http\Requests\Ste\DetachPermissionRequest;
...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        $roles = $organization->roles()->getOrPaginate();
    ...
    {
        $organization = request()->user()->organization;
        $role = $organization->roles()->findOrFail($roleId);
